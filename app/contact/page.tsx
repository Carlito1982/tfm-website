    ...
    <div>
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "64px 24px" }}>
        <div style={{
          ...
          <div>
            <h2 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "24px", color: BLACK, marginBottom: "28px" }}>
              Contact details
            </h2>

            <div style={{ marginBottom: "32px" }}>
              <p style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "12px", fontWeight: "bold", letterSpacing: "0.1em", color: COPPER, textTransform: "uppercase", marginBottom: "6px" }}>
                Editor
              </p>
              <p style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "16px", color: BLACK, marginBottom: "4px" }}>Carlos Garcia</p>
              <p style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "14px", color: "#555" }}>The Furniture Magazine / The Talent Branch Ltd</p>
            </div>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <a href="mailto:carlos@thetalentbranch.com" style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "15px", color: GREEN }}>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <a href="tel:07792797476" style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "15px", color: GREEN }}>
                07792 797476
              </a>
            </div>
            ...
            <div style={{ marginBottom: "40px" }}>
              ...
              <div style={{ display: "flex", gap: "16px" }}>
                <a href="https://www.linkedin.com/company/thefurnituremagazine" target="_blank" rel="noopener noreferrer"
                  style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "14px", color: GREEN }}>
                  LinkedIn
                </a>
            ...
            <div style={{ backgroundColor: "#E8DEC8", border: `1px solid ${BORDER}`, padding: "28px" }}>
              <h3 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "18px", color: BLACK, marginBottom: "16px" }}>
                Quick contact
              </h3>
              {reasons.map((r) => (
                <a
          ...
          <div>
            ...
            {[
              ...
              <div key={item.title} style={{ marginBottom: "32px", paddingLeft: "20px", borderLeft: `3px solid ${COPPER}` }}>
                <h3 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "17px", color: BLACK, marginBottom: "8px" }}>
                  {item.title}
                </h3>
                <p style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "14px", color: "#555", lineHeight: 1.7 }}>
                  {item.body}
                </p>
              </div>
            ))}
