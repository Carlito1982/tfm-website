    ...
    <div>
      ...
      <div style={{ backgroundColor: GREEN, padding: "72px 24px" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "clamp(32px, 5vw, 52px)", color: CREAM, lineHeight: 1.15 }}>
      ...
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "64px 24px" }}>
        ...
        <h2 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "26px", color: BLACK, marginBottom: "16px" }}>
        ...
        {[
          ...
          <div key={title} style={{ marginBottom: "28px", paddingLeft: "20px", borderLeft: `3px solid ${COPPER}` }}>
            <h3 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "18px", color: BLACK, marginBottom: "6px" }}>
              {title}
            </h3>
            <p style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "15px", color: "#555", lineHeight: 1.7 }}>
              {body}
            </p>
          </div>
        ))}
        ...
        <p style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "16px", color: "#444", lineHeight: 1.8, marginBottom: "36px" }}>
